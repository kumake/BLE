...
//5¸öÔªËØ
#define SERVAPP_NUM_ATTR_SUPPORTED        (1+5*3)
...
static uint8 simpleProfileChar1[SIMPLEPROFILE_CHAR1_LEN] = { 0xFD, 0xA5, 0x06, 0x93, 0xA4, 0xE2, 0x4F,0xB1, 0xAF, 0xCF, 0xC6, 0xEB, 0x07, 0x64, 0x78, 0x25,};

// Simple Profile Characteristic 1 User Description
static uint8 simpleProfileChar1UserDesp[6] = "UUID\0";


// Simple Profile Characteristic 2 Properties
static uint8 simpleProfileChar2Props = GATT_PROP_READ | GATT_PROP_WRITE;//by xiaoku

// Characteristic 2 Value
static uint8 simpleProfileChar2 = 0;

// Simple Profile Characteristic 2 User Description
static uint8 simpleProfileChar2UserDesp[7] = "Major\0"; //by xiaoku


// Simple Profile Characteristic 3 Properties
static uint8 simpleProfileChar3Props = GATT_PROP_READ |GATT_PROP_WRITE;//by xiaoku

// Characteristic 3 Value
static uint8 simpleProfileChar3 = 0;

// Simple Profile Characteristic 3 User Description
static uint8 simpleProfileChar3UserDesp[7] = "Minor\0"; //by xiaoku
...
//static gattCharCfg_t simpleProfileChar4Config[GATT_MAX_NUM_CONN];  //by xiaoku
...
// Characteristic 1 Value
static uint8 simpleProfileChar1[SIMPLEPROFILE_CHAR1_LEN] = "abcdseeeee";

// Simple Profile Characteristic 1 User Description
static uint8 simpleProfileChar1UserDesp[] = "DEV_NAME\0";
...
// Characteristic 2 Value
static uint8 simpleProfileChar2[SIMPLEPROFILE_CHAR2_LEN] = { 0xFD, 0xA5, 0x06, 0x93, 0xA4, 0xE2, 0x4F,0xB1, 0xAF, 0xCF, 0xC6, 0xEB, 0x07, 0x64, 0x78, 0x25,};

// Simple Profile Characteristic 2 User Description
static uint8 simpleProfileChar2UserDesp[] = "UUID\0"; //by xiaoku
...
// Characteristic 3 Value
static uint8 simpleProfileChar3[SIMPLEPROFILE_CHAR3_LEN] = { 0x00, 0x03};

// Simple Profile Characteristic 3 User Description
static uint8 simpleProfileChar3UserDesp[7] = "MAJOR\0"; //by xiaoku
...
// Characteristic 4 Value
static uint8 simpleProfileChar4[SIMPLEPROFILE_CHAR4_LEN] = { 0x00, 0x04};

                                  
// Simple Profile Characteristic 4 User Description
static uint8 simpleProfileChar4UserDesp[] = "MINOR\0";
...
// Characteristic 5 Value
static uint8 simpleProfileChar5 = 0x12;

// Simple Profile Characteristic 5 User Description
static uint8 simpleProfileChar5UserDesp[] = "Mea p";
...
bStatus_t SimpleProfile_AddService( uint32 services )
{
  ...
  //GATTServApp_InitCharCfg( INVALID_CONNHANDLE, simpleProfileChar4Config );//by xiaoku
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR3_UUID:
		if ( offset == 0 )
	        ...
	        {
	        	uint8 *pCurValue = (uint8 *)pAttr->pValue;
			VOID osal_memcpy( pCurValue, pValue, SIMPLEPROFILE_CHAR3_LEN );
      ...
      case SIMPLEPROFILE_CHAR4_UUID:
	  	if ( offset == 0 )
	        ...
	        {
	        	uint8 *pCurValue = (uint8 *)pAttr->pValue;
			VOID osal_memcpy( pCurValue, pValue, SIMPLEPROFILE_CHAR4_LEN );
...
{ 
  ...
  if ( connHandle != LOOPBACK_CONNHANDLE )
  {
    ...
    { 
      //GATTServApp_InitCharCfg( connHandle, simpleProfileChar4Config ); //by xiaoku
    }
  }
}
